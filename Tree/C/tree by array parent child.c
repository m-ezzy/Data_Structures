//program 2
//def : linear representation of tree using array. find left right child of entered parent node
...
void main(){
	...
	printf("\n enter child node index \n");
	scanf("\n %d",&child);

	side = (child%2)?1:2;

	printf("\n parent node index : %d \n value : %d",(child - side)/2,tree[(child - side)/2]);
